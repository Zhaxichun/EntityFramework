...
namespace Microsoft.EntityFrameworkCore.SqlServer.FunctionalTests
{
        ...
        : ComplexNavigationsOwnedQueryTestBase<SqlServerTestStore, ComplexNavigationsOwnedQuerySqlServerFixture>
    {
        ...
        public override void Simple_owned_level1()
        {
            ...
            AssertSql(
                @"SELECT [l1].[Id], [l1].[Date], [l1].[Name], [l1].[Id], [l1].[OneToOne_Required_PK_Date], [l1].[OneToOne_Required_PK_Level1_Optional_Id], [l1].[OneToOne_Required_PK_Level1_Required_Id], [l1].[OneToOne_Required_PK_Name],
[l1].[OneToOne_Required_PK_OneToOne_Optional_PK_InverseId]
FROM [Level1] AS [l1]");
        }
